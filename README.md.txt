...
Features:
Answer questions based on a provided corpus of PDF documents.
Handle out-of-scope queries by directing users to contact the business directly.
